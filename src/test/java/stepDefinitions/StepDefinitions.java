...
public class StepDefinitions {
    ...
    public void user_is_on_the_home_page() {
        ...
        driver = BrowserUtil.getDriver();   // 👈 change here
    ...
    public void product_should_be_added_successfully_to_cart() {
        ...
        softAssert.assertTrue(
                actualMessage.toLowerCase().contains("added to cart"),
                "Product was not added to cart successfully. Actual message: " + actualMessage
        );
